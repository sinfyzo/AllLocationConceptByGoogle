...
package com.alllocationconceptbygoogle.locationupdatesforegroundservice;
...
import com.alllocationconceptbygoogle.MainActivity;
import com.alllocationconceptbygoogle.R;
 ...
 */
public class LocationServiceForegroundActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_location_service_foreground);
        ...
        if (shouldProvideRationale) {
            ...
            Snackbar.make(
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(LocationServiceForegroundActivity.this,
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (location != null) {
                Toast.makeText(LocationServiceForegroundActivity.this, Utils.getLocationText(location),
