...
package com.alllocationconceptbygoogle.locationupdatespendingintent;
 ...
 */
public class LocationServicePendingIntentActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_location_service_pending_intent);
            ...
            Snackbar.make(
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(LocationServicePendingIntentActivity.this,
